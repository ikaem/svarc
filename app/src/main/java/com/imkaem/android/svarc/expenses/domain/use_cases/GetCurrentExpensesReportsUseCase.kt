...
class GetCurrentExpensesReportsUseCase @Inject constructor(
    ...
    *   and it should return a flow */
    ...
    operator fun invoke(): Flow<CurrentPeriodsAmountValues> {


        val (fromMillisInclusive, toMillisInclusive) = getCurrentMonthMillis()
...
private fun getCurrentMonthMillis(): Pair<Long, Long> {
    ...
    val daysInMonth = nowZonedDateTime.toLocalDate().lengthOfMonth()
